...
public class TestHTTP extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new HttpAsyncTaskGet().execute("http://192.168.0.101:4433/");
		...
		public void onClick(View view) {
			...
			switch(view.getId()){
				case R.id.btnPost:
					...
					new HttpAsyncTask().execute("http://192.168.0.101:4433/");
				break;
			}
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
        	...
        	device.setTime(etData.getText().toString());
    	
            return POST(urls[0],device);
        }
