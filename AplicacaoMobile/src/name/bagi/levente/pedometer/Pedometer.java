...
public class Pedometer extends Activity {
	...
	private  String strDateGlobal = "";
	private int mStepValueaux          = 0;
    private int mPaceValueaux          = 0;
    private int mCaloriesValueaux      = 0;
                ...
                case CALORIES_MSG:
                    ...
                    if (mCaloriesValue <= 0) { 
                        ...
                        if(mCaloriesValue != mCaloriesValueaux  && mCaloriesValue != 0){
                        	...
                        	rest.PostService(device);
                        	mCaloriesValueaux = mCaloriesValue;
                        }
                    }
                    break;
                default:
